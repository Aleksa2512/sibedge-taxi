...
trait Response
{
    ...
    {
        throw new NotFoundHttpException(trans('errors.not_found'));
    }
    ...
    {
        $manager = $this->getArrayManager();
        $array = ['data' => $manager->createData(new Item($item, $transformer))->toArray()];
     ...
     * @return \Illuminate\Http\JsonResponse
     */
    protected function exceptionError(Throwable $e, int $code, $transformer = null, array $headers = [])
    {
        $item    = new Item($e, $transformer ?: new ErrorTransformer($code));
